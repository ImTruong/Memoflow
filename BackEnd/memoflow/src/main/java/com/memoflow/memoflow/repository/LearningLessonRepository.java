...
public interface LearningLessonRepository extends JpaRepository<LearningLesson, Long> {
        ...
        @Query("SELECT COUNT(l) FROM LearningLesson l WHERE l.type LIKE :prefix AND l.deleted = false")
        long countByTypeStartingWithAndDeletedFalse(@Param("prefix") String prefix);
        ...
        @Query("SELECT l FROM LearningLesson l " +
                        ...
                        "OR LOWER(l.description) LIKE LOWER(CONCAT('%', :keyword, '%'))) " +
                        "ORDER BY FUNCTION('STR_TO_DATE', FUNCTION('JSON_UNQUOTE', FUNCTION('JSON_EXTRACT', l.content, '$.createdAt')), '%Y-%m-%d %H:%i:%s.%f') DESC")
        Page<LearningLesson> findBilingualReadNewest(@Param("keyword") String keyword, @Param("userId") Long userId,
                        Pageable pageable);
        ...
        @Query("SELECT l FROM LearningLesson l " +
                        ...
                        "OR LOWER(l.description) LIKE LOWER(CONCAT('%', :keyword, '%'))) " +
                        "ORDER BY FUNCTION('STR_TO_DATE', FUNCTION('JSON_UNQUOTE', FUNCTION('JSON_EXTRACT', l.content, '$.createdAt')), '%Y-%m-%d %H:%i:%s.%f') ASC")
        Page<LearningLesson> findBilingualReadOldest(@Param("keyword") String keyword, @Param("userId") Long userId,
                        Pageable pageable);
        ...
        @Query("SELECT l FROM LearningLesson l " +
                        ...
                        "OR LOWER(l.description) LIKE LOWER(CONCAT('%', :keyword, '%'))) " +
                        "ORDER BY FUNCTION('JSON_UNQUOTE', FUNCTION('JSON_EXTRACT', l.content, '$.views')) DESC")
        Page<LearningLesson> findBilingualReadPopular(@Param("keyword") String keyword, @Param("userId") Long userId,
                        Pageable pageable);
        ...
        @Query("SELECT l FROM LearningLesson l " +
                        ...
                        ") " +
                        "ORDER BY FUNCTION('STR_TO_DATE', FUNCTION('JSON_UNQUOTE', FUNCTION('JSON_EXTRACT', l.content, '$.createdAt')), '%Y-%m-%d %H:%i:%s.%f') DESC")
        Page<LearningLesson> findBilingualUnreadNewest(@Param("keyword") String keyword, @Param("userId") Long userId,
                        Pageable pageable);
        ...
        @Query("SELECT l FROM LearningLesson l " +
                        ...
                        ") " +
                        "ORDER BY FUNCTION('STR_TO_DATE', FUNCTION('JSON_UNQUOTE', FUNCTION('JSON_EXTRACT', l.content, '$.createdAt')), '%Y-%m-%d %H:%i:%s.%f') ASC")
        Page<LearningLesson> findBilingualUnreadOldest(@Param("keyword") String keyword, @Param("userId") Long userId,
                        Pageable pageable);
        ...
        @Query("SELECT l FROM LearningLesson l " +
                        ...
                        ") " +
                        "ORDER BY FUNCTION('JSON_UNQUOTE', FUNCTION('JSON_EXTRACT', l.content, '$.views')) DESC")
        Page<LearningLesson> findBilingualUnreadPopular(@Param("keyword") String keyword, @Param("userId") Long userId,
                        Pageable pageable);
